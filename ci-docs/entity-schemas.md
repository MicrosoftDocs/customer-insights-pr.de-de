...
Entitäten im [Common Data Model Entity Navigator](https://microsoft.github.io/CDM/) anzeigen. Wählen Sie im Abschnitt Erkenntnis-Anwendung eine Entität aus, um die Liste der Customer Insights Entitäten und deren Definitionen abzurufen.

:::image type="content" source="media/CDM-entity-navigator.png" alt-text="CDM-Entitätsnavigator mit CustomerActivity-Entität.":::
